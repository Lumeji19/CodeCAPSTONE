...
METHODS = {
    "standard": StandardSVM,
    "stable":   StableSVM,
    "balanced": BalancedSVM,
}
...
def run_one_dataset(dataset_name: str) -> pd.DataFrame:
    ...
    csv_path = RESULTS_DIR / f"{dataset_name}_svm_{SCHEME}.csv"
...
def main():
    ...
    combined_path = RESULTS_DIR / f"pilot_svm_{SCHEME}_combined.csv"
    ...
    print(f"Pilot complete. Combined results: {combined_path}")
